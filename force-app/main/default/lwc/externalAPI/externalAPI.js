...
import sendParams from "@salesforce/apex/externalAPIController.sendParams";
...
export default class ExternalAPI extends LightningElement {
  ...
  handleClick() {
    ...
    console.log("params ", parameterObject);
    sendParams(parameterObject)
      .then((result) => {
        this.message = result;
